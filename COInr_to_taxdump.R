...
coinr_data$tax_id <- abs(coinr_data_neg$tax_id) + opt$new_taxids
coinr_data$parent_tax_id[coinr_data_neg$parent_tax_id<0] <- abs(coinr_data_neg$parent_tax_id[coinr_data_neg$parent_tax_id<0]) + opt$new_taxids
